        ...
        if ($server_output != null && $server_output->statusCode == 200 && $server_output->data && $server_output->data->providerResponse) {
            SafeVerification::updateOrCreate(
                ...
                [
                    ...
                    'dateOfBirth'  => $server_output->data->providerResponse->dateOfBirth ?? $server_output->data->providerResponse->dob ?? "",
                    'phoneNumber1' => $server_output->data->providerResponse->phoneNumber1 ??  $server_output->data->providerResponse->phone ?? "",
